      ...
      <main>
        ...
        <MarketingShell withCta={false}>
          <Disclaimer tone="warning">
            ...
            <span className="text-muted-foreground">This page is a product specification. The legally binding Terms will be reviewed by qualified counsel before launch.</span>
          </Disclaimer>
