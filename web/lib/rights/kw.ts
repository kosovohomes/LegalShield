...
/**
 * Kuwait jurisdiction content for the client-rights hub.
 * Procedural specifics are marked `verified: false` — laws, fees and bar
 * processes in the State of Kuwait change; each unverified item renders a
 * "verify with the official source" badge and the page carries a full
 * not-legal-advice disclaimer. Institutional names are stable facts.
 */
export const kw: JurisdictionRights = {
  country: "KW",
  name: { en: "Kuwait", ar: "الكويت" },
  flag: "🇰🇼",
  intro: {
    en: "A plain-language guide to what you are entitled to when you hire a lawyer in the State of Kuwait, what your lawyer is professionally required to do, and the channels available to you if things go wrong. This page describes rights and duties in general terms so you can navigate a difficult situation more confidently — it is not a substitute for a lawyer's advice on your specific case.",
    ar: "دليل بلغة واضحة لحقوقك عندما توكّل محامياً في دولة الكويت، وما يلتزم به المحامي مهنياً تجاهك، والقنوات المتاحة لك إذا حدث خلل في العلاقة. تصف هذه الصفحة الحقوق والواجبات بعبارات عامة لتمنحك ثقة أكبر في التعامل مع موقف صعب، وهي ليست بديلاً عن استشارة محامٍ في حالتك الخاصة.",
  },
  basis: {
    en: "These expectations rest on Kuwait's legal framework — the Civil Code (Law No. 67/1980), the Code of Civil & Commercial Procedure, the Law Regulating the Legal Profession and its 2002 executive regulations, and the professional conduct expected by the Kuwait Bar Association — alongside general principles of agency and good faith.",
    ar: "تستند هذه التوقعات إلى الإطار القانوني الكويتي — القانون المدني (القانون رقم 67/1980)، وقانون المرافعات المدنية والتجارية، والقانون المنظم لمهنة المحاماة ولائحته التنفيذية لعام 2002، وآداب المهنة المتعارف عليها لدى جمعية المحامين الكويتية — إضافةً إلى المبادئ العامة للوكالة وحسن النية.",
  },
  rightsLead: {
    en: "Basic, essential rights of a client in Kuwait",
    ar: "حقوقك الأساسية والجوهرية كموكّل في الكويت",
  },
  rights: [
    {
      id: "clear-terms",
      ...
      body: {
        en: "You are entitled to know, up front and in writing where possible: what the lawyer will do, at which stage your case stands, and how their fees are calculated (fixed, hourly, or a percentage consistent with the legal fee rules). A written fee agreement protects both sides and prevents later disputes.",
        ar: "من حقك أن تعرف مسبقاً وبشكل واضح — كتابياً كلما أمكن — ما الذي سيقوم به المحامي، وفي أي مرحلة يمرّ بها قضيتك، وكيف تُحتسب أتعابه (مبلغ مقطوع، أو أجر بالساعة، أو نسبة وفقاً لقواعد الأتعاب المنظمة). الاتفاق الكتابي على الأتعاب يحمي الطرفين ويقي من الخلافات لاحقاً.",
      },
    },
    {
      id: "informed",
  ...
  duties: [
    {
      ...
      standard: {
        en: "Professional conduct rules under the legal profession law.",
        ar: "آداب المهنة وفقاً لقانون تنظيم مهنة المحاماة.",
      },
    },
    {
      id: "confidentiality",
    ...
    },
    {
      ...
      standard: {
        en: "Restraint and good-faith dealing in attorney–client relations.",
    ...
    },
    {
      ...
      body: {
        en: "Agree fees clearly, issue receipts for what you pay, and charge within the limits set by law — neither overcharging nor collecting unlawful or unconscionable amounts.",
        ar: "أن يُحدد الأتعاب بوضوح، ويصدر إيصالاً بما يُدفع، وألا يتقاضى ما يخالف القانون أو يتجاوز الحدود المعقولة والمقررة للأتعاب.",
      },
      standard: {
        en: "The legal fee provisions in the profession's regulations.",
        ar: "أحكام الأتعاب الواردة في اللائحة المنظمة للمهنة.",
      },
    },
    {
      id: "accounting",
      ...
      standard: {
        ...
        ar: "قواعد حفظ أموال الموكلين وقواعد التأديب لدى نقابة المحامين.",
      },
    },
    {
      id: "candor",
      title: { en: "Duty of candor toward the court", ar: "واجب الصدق تجاه القضاء" },
      body: {
  ...
  courses: {
    misconduct: {
      ...
      body: {
        ...
        ar: "هو مخالفة آداب المهنة أو أصولها — مثل إهمال ملفك، أو إفشاء أسرارك، أو العمل ضد مصلحتك، أو التخلف عن جلسة دون عذر، أو ممارسات أتعاب تحظرها القواعد. قد يوجد الخطأ التأديبي حتى دون أن يلحق بك ضرر مالي، وينظر فيه أمام جهات التأديب في الجمعية.",
      },
      indicators: [
  ...
  actions: [
    {
      ...
      title: { en: "File a complaint with the Kuwait Bar Association", ar: "تقديم شكوى إلى جمعية المحامين الكويتية" },
      body: {
        en: "A complaint about professional conduct is examined by the Kuwait Bar Association and its disciplinary bodies, which can impose sanctions that range from a warning to, in serious cases, suspension or striking off. The association can also address disputes over fees.",
        ar: "تُعرض شكاوى آداب المهنة على جمعية المحامين الكويتية وجهات التأديب التابعة لها، ويجوز لها توقيع جزاءات تبدأ بالتنبيه وقد تصل — في الحالات الجسيمة — إلى الإيقاف أو شطب القيد. كما تتولى الجمعية النظر في الخلافات المتعلقة بالأتعاب.",
      },
      bestFor: {
      ...
      steps: [
        {
          ...
          body: {
            en: "Complaint channels, required forms, and the supporting annex format are set by the Association and may change. Confirm the current filing procedure on the Association's official channels before submitting.",
            ar: "تحدد الجمعية قنوات تقديم الشكوى والنماذج المطلوبة وصيغة المرفقات، وقد تتغير. تحقق من إجراءات التقديم الحالية عبر القنوات الرسمية للجمعية قبل الإرسال.",
          },
          authority: "Kuwait Bar Association",
        },
        {
      ...
      parallel: {
        ...
        ar: "شكوى الجمعية لا تمنع رفع دعوى تعويض عن ضررك، ولا تُغني هي بذاتها عن الحكم لك بتعويض.",
      },
    },
    {
      id: "civil-claim",
      ...
      steps: [
        {
          ...
          body: {
            en: "Before suing a lawyer, discuss the merits, the limitation period that applies, and the evidence with a lawyer unconnected to the dispute.",
    ...
    },
    {
      ...
      body: {
        en: "Disputes about the amount of fees can be raised — first by requesting a written account, then through the bar's mediation/complaint channels or, where the law so provides, before the court that has jurisdiction over fees.",
        ar: "يمكن الاعتراض على قيمة الأتعاب — أولاً بطلب حساب كتابي، ثم عبر قنوات التوفيق أو الشكوى لدى الجمعية، أو أمام الجهة القضائية المختصة بالأتعاب حيث يجيز القانون ذلك.",
      },
      bestFor: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: {
            en: "Kuwaiti procedure encourages seeking an amicable solution before escalation; document the offers and the response.",
            ar: "يشجّع المسار في الكويت على الحل الودي قبل التصعيد؛ وثّق العروض والردود.",
          },
        },
        {
          title: { en: "Escalate through the bar or the courts", ar: "صعّد عبر الجمعية أو القضاء" },
          body: {
            ...
            ar: "حيث تجيز القواعد والقانون، يمكن إحالة النزاع على الأتعاب إلى قنوات الجمعية أو جهة قضائية مختصة — تحقق من المسار الحالي.",
          },
        },
      ],
      verified: false,
      parallel: {
        ...
        ar: "حبس ملفك للضغط من أجل الدفع يجب اختباره في ذاته أمام القواعد — وقد تحتاج إلى محامٍ أو إلى تدخل الجمعية للمطالبة بردّه كخطوة مستقلة.",
      },
    },
  ],
  parallelLead: {
  ...
  parallel: [
    ...
    {
      en: "Limitation periods apply and are not paused; verify the applicable period for your claim early.",
...
{CLIENT_ADDRESS}` },
      ...
      {
        id: "bar-complaint",
        title: { en: "Complaint to the Kuwait Bar Association", ar: "شكوى إلى جمعية المحامين الكويتية" },
        recipient: { en: "Kuwait Bar Association", ar: "جمعية المحامين الكويتية" },
        body: { en: `Date: {TODAY}

To: The Kuwait Bar Association — Complaints / Disciplinary Committee
{ASSOCIATION_ADDRESS}
...
إلى: جمعية المحامين الكويتية — لجنة الشكاوى/التأديب
{ASSOCIATION_ADDRESS}
...
أوضح أنني لا أطلب من الجمعية الفصل في نتيجة قضيتي، وإنما في السلوك المهني الموصوف أعلاه.
...
المرفقات: {ATTACHMENT_LIST}` },
  ...
  resources: [
    {
      id: "kw-bar",
      authority: { en: "Kuwait Bar Association", ar: "جمعية المحامين الكويتية" },
      role: {
        en: "Complaints on professional conduct; mediators of fee disputes; disciplinary referral.",
        ar: "النظر في شكاوى آداب المهنة، والوساطة في نزاعات الأتعاب، والإحالة للتأديب.",
      },
      verified: true,
      note: {
    ...
    {
      id: "kw-justice",
      authority: { en: "Ministry of Justice — State of Kuwait", ar: "وزارة العدل — دولة الكويت" },
      role: {
        en: "Courts and judicial affairs; supervision of the legal profession as provided by law.",
        ar: "شؤون المحاكم والقضاء؛ والإشراف على مهنة المحاماة فيما يحدده القانون.",
      },
      verified: true,
    },
    {
  ...
  verify: {
    en: "This page describes rights and duties in general terms. Kuwaiti procedures for complaints, fee disputes and civil claims are set by current law and by the bar's regulations, which change over time. Verify every step, deadline and address with the official sources before you act, and take independent legal advice on your own facts.",
    ar: "تصف هذه الصفحة الحقوق والواجبات بعبارات عامة. وتحدَّد إجراءات الشكاوى ومنازعات الأتعاب والدعاوى المدنية في الكويت بالقانون الحالي ولوائح الجمعية، وهي قابلة للتغيير. تحقق من كل خطوة وموعد وعنوان مع الجهات الرسمية قبل المضي، واستشر محامياً مستقلاً في وقائعك الخاصة.",
  },
  updated: {
